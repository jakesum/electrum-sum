...
from electrum_bynd.bitcoin import TYPE_ADDRESS, int_to_hex, var_int, is_segwit_script_type
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Sumcoin" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in Sumcoin mode")) from e
                raise e
